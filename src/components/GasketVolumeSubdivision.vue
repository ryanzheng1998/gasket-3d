...
@Component
export default class GasketVolumeSubdivision extends Vue {
  // prop
  ...
  mounted () {
    ...
    // vertex point + color
    //
    let gasketVertexDataGen = (a: Point, b: Point, c: Point, d: Point, gasketDivisionCount: number) :void => {
      ...
      let p4: Point = { x: 0, y: 0, z: 0 }
      let p5: Point = { x: 0, y: 0, z: 0 }
      let p6: Point = { x: 0, y: 0, z: 0 }
      let iterater: number
      if (gasketDivisionCount > 0) {
        ...
        gasketVertexDataGen(a, p1, p2, p5, gasketDivisionCount - 1)
        gasketVertexDataGen(p2, p3, c, p6, gasketDivisionCount - 1)
        gasketVertexDataGen(p1, b, p3, p4, gasketDivisionCount - 1)
        gasketVertexDataGen(p5, p4, p6, d, gasketDivisionCount - 1)
      } else {
        this.vertexData.push(a.x, a.y, a.z, 1.0, 0.0, 0.0, b.x, b.y, b.z, 1.0, 0.0, 0.0, c.x, c.y, c.z, 1.0, 0.0, 0.0)
        this.vertexData.push(a.x, a.y, a.z, 0.0, 1.0, 0.0, b.x, b.y, b.z, 0.0, 1.0, 0.0, d.x, d.y, d.z, 0.0, 1.0, 0.0)
        this.vertexData.push(a.x, a.y, a.z, 0.0, 0.0, 1.0, d.x, d.y, d.z, 0.0, 0.0, 1.0, c.x, c.y, c.z, 0.0, 0.0, 1.0)
        this.vertexData.push(d.x, d.y, d.z, 1.0, 1.0, 1.0, b.x, b.y, b.z, 1.0, 1.0, 1.0, c.x, c.y, c.z, 1.0, 1.0, 1.0)
      }
    }
    ...
    gasketVertexDataGen(this.gasketInitalVertex[0], this.gasketInitalVertex[1], this.gasketInitalVertex[2], this.gasketInitalVertex[3], this.gasketDivisionCount)
